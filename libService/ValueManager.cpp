...
class ValueHolder
{
  ...
  QHash<QString, ValueModel*> models;
...
void ValueHolder::dump() {
  QHash<QString, ValueModel*>::const_iterator i = models.constBegin();
...
ValueHolder* ValueManager::instance = nullptr;
